...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Arrow function written by Zeegii:', sum(1, 2, 3, 4));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Object Lit written by ZG', objectLit());
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('by Zg:', sumAndProduct(3, 9));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('by Zg:', message('Allie'));
...
//  'this' refers to joe object instance of the Student constructor function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//  Since the arrow function doesn't have their own this value, 'this' in the scopeArrow refers to the global 'window' object.
// 3. Explain why "this" is different when an arrow function is used.
//In arrow functions, this keyword does not have its own value. Instead, the value of this inside an arrow function is always inherited from its surrounding lexical context (the context in which the arrow function is defined). This means that this inside an arrow function will always refer to the this value of the enclosing function or the global object if the arrow function is defined in the global scope.